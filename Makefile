...
#CXXFLAGS=-O2 -Wall -fPIC -pthread -std=c++17 -m64 -I${SW_ROOT}/ROOT/latest/include
...
libMFTAnaSim.so: DictMFTAnaSim.cxx $(SOURCES)
	g++ -shared -o $@ $(CXXFLAGS) -I$(ROOTSYS)/include -I${O2_ROOT}/include -I${O2_ROOT}/include/GPU -I${SW_ROOT}/ms_gsl/latest/include -I${SW_ROOT}/FairLogger/latest/include -I${SW_ROOT}/fmt/latest/include -I${SW_ROOT}/FairRoot/latest/include $^
